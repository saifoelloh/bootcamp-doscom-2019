...
<html lang="en">
  ...
  <body>
      <div class="purple-dark" id="home">
          <div class="navigasi fixed-top purple-dark">
              <nav class="navbar navbar-expand-lg container" id="navmenu">
                  <a class="navbar-bran d page-scroll w-25 mt-2" href="#home"><img class="nav-logo" src="/assets/icons/logo.png" alt="" width="80%"></a>
              ...
              <div class="container h-100">
                  <div class="row h-100 align-content-center">
                      ...
                      <div class="col-md-6 hide-gambar mt-4">
                          <div class="keygambar">
                              <img class="mx-auto d-block ilu-gmbr" src="/assets/icons/ilustrasi.png" width="100%" alt="">
                          </div>
                      </div>
                    </div>
                </div>
                      ...
                      <div class="benefit">
                        <ul class="list-unstyled">
                            <li class="media gambar-benefit">
                              <img class="mr-3" src="assets\icons\ilmu-odd-icon.png" alt="Generic placeholder image">
                            ...
                            <li class="media my-4 gambar-benefit">
                              <img class="mr-3" src="assets\icons\teman-odd-icon.png" alt="Generic placeholder image">
                              <div class="media-body">
                            ...
                            <li class="media gambar-benefit">
                              <img class="mr-3" src="assets\icons\game-odd-icon.png" alt="Generic placeholder image">
                              <div class="media-body">
              ...
              <div class="list-gambar mt-5 ">
                  <div class="row">
                      <div class="col-6 col-sm-6  col-md-3  my-2">
                          <img class="img-thumbnail hover-gmbr" src="assets/images/DSC_7004.JPG" alt="">
                      </div>
                      <div class="col-6 col-sm-6  col-md-3 my-2">
                          <img class="img-thumbnail hover-gmbr" src="assets/images/DSC_7071-min.JPG" alt="">
                      </div>
                      <div class="col-6 col-sm-6  col-md-3 my-2">
                          <img class="img-thumbnail hover-gmbr" src="assets/images/8f63e15a-3a67-458d-924b-bed8279eabc1.jpg" alt="">
                      </div>
                      <div class="col-6 col-sm-6  col-md-3 my-2">
                          <img class="img-thumbnail hover-gmbr" src="assets/images/DSC_7091-min.JPG" alt="">
                      </div>
                      <div class="col-6 col-sm-6  col-md-3 my-2">
                          <img class="img-thumbnail hover-gmbr" src="assets/images/DSC_7185-min.JPG" alt="">
                      </div>
                      <div class="col-6 col-sm-6  col-md-3 my-2">
                          <img class="img-thumbnail hover-gmbr" src="assets/images/IMG_1879.JPG" alt="">
                      </div>
                      <div class="col-6 col-sm-6  col-md-3 my-2">
                          <img class="img-thumbnail hover-gmbr" src="assets/images/IMG_1908.JPG" alt="">
                      </div>
                      <div class="col-6 col-sm-6  col-md-3 my-2">
                          <img class="img-thumbnail hover-gmbr" src="assets/images/DSC_7079-min.JPG" alt="">
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="row h-100 align-content-center pb-5">
                  ...
                  <div class="col-md-6 mx-auto">
                          <div class="row acara mb-5">
                              ...
                              <div class="col-6 col-sm-4 col-md-4 py-2 px-2 list-acara" id="list-acara">
                                        <img class=" mx-auto d-block " src="assets\icons\teman-icon.png" alt="">
                              ...
                              <div class="col-6 col-sm-4 col-md-4 py-2 px-2 list-acara" id="list-acara">
                                        <img class=" mx-auto d-block " src="assets\icons\game-icon.png" alt="">
                                        <h5 class="text-center">Games</h5>
                                        <p class="text-center">Banyak games menarik dan seru dalam kegiatan.</p>
                              </div>
                              <div class="col-6 col-sm-4 col-md-4 py-2 px-2 list-acara" id="list-acara">
                                        <img class=" mx-auto d-block " src="assets\icons\ilmu-icon.png" alt="">
                    ...
                    <form class="mb-5 mt-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 list-from">
                                    <input type="submit" value="Daftar" class="px-5 py-2 my-2 mx-auto d-block" id="btn-daftar" style="color: #fff">
                                </div>
                            </div>
                    </form>
                </div>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
        ...
        <script src="/assets/jquery_swing.js"></script>
